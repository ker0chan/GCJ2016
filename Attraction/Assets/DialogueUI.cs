...
public class DialogueUI : Yarn.Unity.DialogueUIBehaviour
{
	...
	public override IEnumerator RunCommand (Yarn.Command command)
	{
		...
		// Example: forward commands that begin with "setexpression" to an ExpressionSwitcher
		var commandElements = command.text.Split(' ');

		if (commandElements.Length > 0) {
			// Syntax for this command = setexpression NAME SPRITENAME
			// GameObject NAME must have a ExpressionSwitcher component
			// The ExpressionSwitcher must have a sprite named SPRITENAME
			if (commandElements[0] == "setexpression") {
				Debug.Log("Finding NPC Portrait "+commandElements[1]);
				var switcher = NPCPortraits.transform.Find(commandElements[1]).GetComponent<ExpressionSwitcher>();
	...
	public override IEnumerator DialogueStarted ()
	{
		...
		foreach(Transform t in NPCPortraits.transform)
		{
